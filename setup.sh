...
qemu-img resize /home/chris/disks/ctrl_node.qcow2 +$CTRL_IMG_SIZE
qemu-img resize /home/chris/disks/work_node.qcow2 +$WORK_IMG_SIZE
qemu-img resize /home/chris/disks/etcd_node.qcow2 +$ETCD_IMG_SIZE
qemu-img resize /home/chris/disks/srvr_node.qcow2 +$SRVR_IMG_SIZE
